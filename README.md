...
- v2.5.0 — Network Analyzer now derives bandwidth/latency metrics from interface data, flags missing speeds or down links, and guards reports against divide-by-zero errors.
- v2.4.0 — Refined dark-mode palette and form surfaces so inputs, checkboxes, and outline actions remain legible across themes, with documentation and badges bumped accordingly.
